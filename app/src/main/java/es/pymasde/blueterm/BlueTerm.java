//BlueTerm.java:  Bluetooth serial terminal.  From https://github.com/johnhowe/BlueTerm
...
/**
 * Class BlueTerm implements a serial terminal via Bluetooth.
 */
...
//        requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
        ...
        if(mTitle == null)                  //make sure not null
...
//	}
    ...
    private final Handler mHandlerBT = new Handler(Looper.getMainLooper()) {
        @Override
...
*/                
            case BluetoothSerialService.MESSAGE_DEVICE_INFO:
                ...
                mConnectedDeviceName = msg.getData().getString(BluetoothSerialService.DEVICE_NAME);
            ...
            case BluetoothSerialService.MESSAGE_SHOWTEXT:
                Toast.makeText(getApplicationContext(), msg.getData().getString(BluetoothSerialService.SHOW_TEXT), Toast.LENGTH_SHORT).show();
                break;
            }
        }
    };
...
//        if (mSerialService != null)
//            mSerialService.processActivityResult(requestCode,resultCode,data);
//    }
...
//        case R.id.connect:
//            if(mSerialService != null)
//                mSerialService.doConnectDeviceAction();
//            return true;
 ...
 */
class EmulatorView extends View implements DataWriteReceiver, GestureDetector.OnGestureListener {
